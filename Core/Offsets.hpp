...
constexpr std::string GAME_VERSION = "v3.0.70.55";
constexpr std::string ZAP_VERSION = "ZAP 1.0.8";
...
constexpr long OFF_OBSERVER_LIST = 0x1EADD28;   //observerList: 48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38     10.05.24
