...
// HUD
constexpr long OFF_VIEWRENDER = 0x769b558; //[Miscellaneous]->ViewRenderer
...
constexpr long OFF_LAST_VISIBLE_TIME = 0x1990;  //[RecvTable.DT_BaseCombatCharacter]->m_hudInfo_visibilityTestAlwaysPasses + 0x3
constexpr long OFF_LAST_AIMEDAT_TIME = 0x1998;  //[RecvTable.DT_BaseCombatCharacter]->m_hudInfo_visibilityTestAlwaysPasses + 0x3 + 0x8
...
constexpr long OFF_OBSERVER_LIST = 0x1f17ee8;   //observerList: 48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38     10.05.24
...
constexpr long OFF_GLOW_HIGHLIGHTS = 0xb13c6a0; //highlightsettings
